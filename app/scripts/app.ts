...
angular.module('avionmakeApp', [
  ...
  .config(($translateProvider:angular.translate.ITranslateProvider) =>{
    ...
    $translateProvider.translations('en', {
         'STEP1': '1. Choose',
         'STEP1_TEXT': 'What model do you want?',
         'STEP2': '2. Draw',
    ...
    .translations('fr', {
         'STEP1': '1. Choisir',
         'STEP1_TEXT': 'Quel modèle voulez-vous?',
         'STEP2': '2. Dessiner',
         'STEP2_TEXT': 'Personnalisez votre avion.',
         'STEP3': '3. Imprimer',
         'STEP3_TEXT': 'Confirmez aperçu?',
         'STEP4': '4. Découper',
         'STEP4_TEXT': 'Observez la découpe laser.',
         'STEP5': '5. Assembler',
         'STEP5_TEXT': 'Collez et pliez ensemble votre avion.',
         'STEP6': '6. Voler',
         'STEP6_TEXT': 'Testez le résultat! Jusqu\'où vole-t-il?',
         'GALLERY': 'Galerie',
         'CHOOSE': 'Choisir',
         'PREVIEW': 'Aperçu',
         'PRINT': 'Imprimer',
         'CREATE': 'Créer',
         'LOADING':'Chargement',
         'MERGE_PDF':'Fusionner PDF pour découper à la main.',
         'NEXT':'Suivant',
         'GENERATING_PDF':'Création du PDF',
         'CONFIRM_NEWPLANE_TITLE':'Nouvelle avion?',
